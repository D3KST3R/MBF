...
def siapa():
	os.system('clear')
	nama = raw_input("\033[1;97mSiapa nama anda ?  \033[1;92m")
	if nama =="":
...
def loginSC():
	os.system('clear')
	print"\033[1;97mSilahkan login SCRIPT nya dulu \n"
...
def login():
	...
	try:
		...
		print"\033[1;93m=========================================="
		print"\033[1;91m------------------------------------------------------------------------------------"
		print"\033[1;91m[!] \033[1;97mSilakan Login lewat opera mini \n    Agar tidak chekpoint saat login"
		print"\033[1;91m------------------------------------------------------------------------------------"
		print 42*"\033[1;96m="
		...
		try:
			...
			if 'access_token' in q:
				...
				if 'www.facebook.com' in q["error_msg"]:
					print '\x1b[1;96m[✖] \x1b[1;93mCHEKPOINT'
